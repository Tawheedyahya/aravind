...
.biz-wrap * { box-sizing: border-box; margin: 0; padding: 0; }
.biz-wrap {
...
@media (max-width: 860px) {
    ...
    .biz-row__img img { height: 240px; }

    .biz-list { padding: 44px 20px 60px; }
    .biz-list__inner { gap: 56px; }
}

@media (max-width: 480px) {
    .biz-hero { padding: 40px 20px 52px; }
    .biz-row__features { grid-template-columns: 1fr; }
    .biz-row__img img { height: 210px; border-radius: 14px; }
    ...
    <section class="biz-list">
        <div class="biz-list__inner">
            ...
            <?php foreach ($businesses as $idx => $b):
                // Alternate: 0=odd(text-left), 1=even(image-left), …
